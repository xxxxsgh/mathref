...
export const OPPONENTS = [
  {
    ...
    ai: { errBase: 0.1, move: 1.6, react: 0.3, readErr: 0.075, reach: 0.42, consistency: 1.15, power: [4.2, 6.2], top: [10, 70], back: 0.15, aggression: 0.15, placement: 0.2, smash: 0.25, depth: 0.45, spinRead: 0.5 },
    reward: 120, xp: 60, games: 2, voice: { pitch: 0.7, rate: 0.95 }, shouts: ['Opa!', 'Essa foi boa!', 'Ainda tenho lenha!', 'Hehe!'],
  },
  {
    ...
    ai: { errBase: 0.055, move: 2.2, react: 0.17, readErr: 0.05, reach: 0.44, consistency: 0.85, power: [5.2, 7.6], top: [20, 80], back: 0.1, aggression: 0.25, placement: 0.55, smash: 0.4, depth: 0.25, spinRead: 0.65 },
    reward: 180, xp: 90, games: 2, voice: { pitch: 1.5, rate: 1.1 }, shouts: ['Vai!', 'Isso!', 'Bora!', 'Paredão!'],
  },
  {
    ...
    ai: { errBase: 0.07, move: 2.4, react: 0.14, readErr: 0.04, reach: 0.45, consistency: 0.75, power: [6.5, 10], top: [120, 230], back: 0.05, aggression: 0.6, placement: 0.65, smash: 0.6, depth: 0.55, spinRead: 0.7 },
    reward: 260, xp: 130, games: 2, voice: { pitch: 1.1, rate: 1.15 }, shouts: ['Yosh!', 'Chore!', 'Hai!'],
  },
  {
    ...
    ai: { errBase: 0.028, move: 2.9, react: 0.14, readErr: 0.035, reach: 0.48, consistency: 0.58, power: [4.8, 7], top: [30, 90], back: 0.85, aggression: 0.2, placement: 0.7, smash: 0.5, depth: 1.25, spinRead: 0.85 },
    reward: 340, xp: 170, games: 2, voice: { pitch: 1.2, rate: 0.9 }, shouts: ['Da!', 'Paciência, querido.', 'Muito bem.'],
  },
  {
    ...
    ai: { errBase: 0.045, move: 3.0, react: 0.11, readErr: 0.03, reach: 0.48, consistency: 0.52, power: [7.5, 12], top: [90, 200], back: 0.08, aggression: 0.85, placement: 0.75, smash: 0.9, depth: 0.6, spinRead: 0.8 },
  ...
  },
  {
    ...
    reward: 800, xp: 400, games: 3, voice: { pitch: 0.85, rate: 0.9 }, shouts: ['Chow!', 'Hao!', 'Concentração.'],
  },
];
...
const DEFAULT = () => ({
  ...
  ach: {},
  daily: { last: '', streak: 0 },
  settings: { sound: true, volume: 0.8, music: true, crowd: true, voice: true, quality: 'alta', speed: 0.85, assist: 1, sens: 1, trail: true, shake: true, camera: 'padrao', replays: true, ghost: true, vibrate: true },
  tutorial: false,
  name: 'Você',
});
